...
module.exports = welcome = async (client, event) => {
    ...
    try {
        if (event.action == 'add' && isWelkom) {
            ...
            const capt = `*[ NEW MEMBER IN GROUP ${name} ]*, *_____________*
<•> *Name* : *${chat.contact.name}* *_____________*

Selamat datang su. Nyolot gw kick, ga suka keluar aja ga ush berisik. baca deskripsi group ya.`
