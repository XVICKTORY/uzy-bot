...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const mess = {
            wait: '[ WAIT ] Sedang di proses⏳ silahkan tunggu sebentar tod',
            error: {
        ...
        const ownerNumber = "6285229528495"
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/uzy12', donate)
            break
        case '!tts':
        ...
        case '!demote':
            ...
            break
        case '!join':
            //return client.reply(from, 'Jika ingin meng-invite bot ke group anda, silahkan izin ke wa.me/6285329981485', id)
